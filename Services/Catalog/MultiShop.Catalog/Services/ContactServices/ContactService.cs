...
namespace MultiShop.Catalog.Services.ContactServices
{
    public class ContactService : IContactService
    {
        ...
        public async Task CreateContactAsync(CreateContactDto createDategoryDto)
        {
            var value = _mapper.Map<Contact>(createDategoryDto);
        ...
        {
            var vv = await _ContactCollection.Find(x => true).ToListAsync();
            return _mapper.Map<List<ResultContactDto>>(vv);
        }
