...
namespace MultiShop.Catalog.Services.SpecialOfferDtos
{
    public class SpecialOfferService : ISpecialOfferService
    {
        ...
        {
            var vv = await _specialOfferCollection.Find(x => true).ToListAsync();
            return _mapper.Map<List<ResultSpecialOfferDto>>(vv);
        }
