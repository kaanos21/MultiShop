...
namespace MultiShop.IdentityServer
{
    public static class Config
    {
        ...
        public static IEnumerable<ApiScope> ApiScopes => new ApiScope[]
        {
            ...
            new ApiScope("CatalogReadPermission","Reading authırity for catalog operations"),
        ...
        public static IEnumerable<Client> Clients => new Client[]
        {
            new Client //visitor
            {
                ...
                AllowedScopes = { "DiscountFullPermission", "CatalogReadPermission", "CatalogFullPermission", "OcelotFullPermission", "CommentFullPermission", "ImageFullPermission" }
            },
            new Client //manager
            {
